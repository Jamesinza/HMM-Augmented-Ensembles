...
def hmm_normal_stack(X_raw, rngs, n=5):
    ...
    for rng in rngs:
        ...
        for _ in range(1):
            ...
            # print(f'\nb: {b}')
            base_features = (np.hstack([base_features, hs1_pred], dtype=np.int8)
...
def train_base_models(dataset, archs, optimizers, dim, seeds, dropout, num_classes, batch_size,
                      epochs, sub_folder, train_ds, val_ds, s):
    for arch in archs:
...
def train_meta_learner(archs, num_classes, batch_size,
                       ...
                       dim, seeds, dropout, X_train, y_train, l=0, t_dim=64):
...
num_heads = 2
seeds = [42, 276, 6, 28]
optimizers = ['adamw','rmsprop','adam','nadam','adamax'] #'adamw','rmsprop','adam','nadam','adamax']
target_set = 'Take5'
...
for dataset in datasets:
    ...
    train_data = data[:splits*9]
    val_data = data[splits*9:int(splits*9.9)]
    del data
    ...
    norm.adapt(adapt_ds)
    del train_data, val_data, adapt_ds
...
# ==================================================================================================
# ========================== Inference Section with Meta Learner ===================================
# ==================================================================================================
...
# tf.keras.backend.clear_session()
# train_meta_learner(archs, num_classes, batch_size,
#                    epochs, datasets, sub_folder, optimizers,
#                    dim, seeds, dropout, X_test, y_test, l=0, t_dim=t_dim)
