...
def train_meta_learner(archs, num_classes, batch_size,
                      epochs, dataset, sub_folder, optimizers, dim, seeds, dropout,
                       X_train, X_val, X_test, y_train, y_val, y_test, base='base', l=0, tot_datasets=0, t_dim=64):
...
optimizers = ['adamw','rmsprop','adamax','nadam','adamax']
...
for _ in range(10):
    ...
    print(f'\nNumber of new features plus original data: {features}\n')
    ...
    meta1, p_train1, p_val1 = train_meta_learner(
        ...
        seeds, dropout, X_train, X_val, X_test, y_train, y_val, y_test,
    ...
    tot_subs += 1
    del meta1, p_train1, p_val1, X_train, X_val, X_test, y_train, y_val, y_test
    ...
    print(f'\nLast 10 entries of data to be used for inference: {data[-10:].flatten()}')
    ...
    print(f'\nLast 10 entries of updated data: {data[-10:].flatten()}')
