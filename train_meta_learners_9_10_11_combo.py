        ...
        for optimizer in ['adamw']:
            for dim in [128]:
                for seed in [42]:
                    ...
                    model.save(
                        f'test_models/{combo_folder}/Meta_L{l}_{optimizer}_dim{dim}_seed{seed}.keras'
                    )                
...
for i, sub_folder in enumerate(sub_folders):
    ...
    for dataset in datasets:
        ...
        meta1, p_train1, p_val1, p_test1 = train_meta_learner(
            ...
            seeds[i], dropout, X_train_reshaped, X_val_reshaped, X_test_reshaped,
...
# meta7, p_train7, p_val7, p_test7 = train_meta_learner(
#     num_classes, batch_size, epochs, dataset, sub_folder, optimizers, dims,
...
# meta8, p_train8, p_val8, p_test8 = train_meta_learner(
#     num_classes, batch_size, epochs, dataset, sub_folder, optimizers, dims,
...
# meta9, p_train9, p_val9, p_test9 = train_meta_learner(
#     num_classes, batch_size, epochs, dataset, sub_folder, optimizers, dims,
...
# meta0, p_train0, p_val0, p_test0 = train_meta_learner(
#     num_classes, batch_size, epochs, dataset, sub_folder, optimizers, dims,
...
for _ in range(10):
    ...
    for i, sub_folder in enumerate(sub_folders):
        ...
        for dataset in datasets:
            ...
            tf.keras.backend.clear_session()
            print(f'\nGetting probabilities from all models in {sub_folder}...')
            base_models = load_base_models(sub_folder, dataset, optimizers, dims, seeds[i], l=0)  # Get models using generator
    ...
    updated_data_raw = np.vstack([updated_data_raw, new_pred], dtype=np.int8)
    print(f'\nLast 10 entries of updated_data_raw: {updated_data_raw[-10:].flatten()}')
