...
def create_base_model(dataset, optimizer, dim, seed, dropout, num_classes):
    ...
    out = layers.TimeDistributed(layers.Dense(dim // 2, activation='relu', kernel_initializer=initializer2))(out)
...
dropout = 0.5
num_heads = 2
seeds =  [37,38,82,83,46,33,49,410,1000]  # [1, 2, 3, 5, 8, 13, 21]  # [6, 28, 42, 95, 138, 276, 496]
dims = [128]
